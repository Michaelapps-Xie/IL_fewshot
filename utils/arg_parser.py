...
def get_argparser():
    ...
    parser = argparse.ArgumentParser("IL_fewshot", add_help=False)

    parser.add_argument('--model_name', default='IL_fewshot', type=str)
    parser.add_argument(
        '--data_path',
        default='',
        type=str
    ...
    parser.add_argument('--nms_iou_threshold', default='0.3', type=float)
